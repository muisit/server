...
use OCA\Files_Sharing\Listener\LegacyLoadAdditionalScriptsListener;
...
class Application extends App {
	...
	protected function registerEventsScripts(IEventDispatcher $dispatcher) {
		...
		$dispatcher->addServiceListener(FilesSharingLoadAdditionalScriptsEvent::class, LegacyLoadAdditionalScriptsListener::class);
